...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_style( 'opcan-styles', get_stylesheet_directory_uri() . '/assets/css/theme.min.css', array(), $css_version );
		...
		wp_enqueue_script( 'opcan-scripts', get_template_directory_uri() . '/assets/js/theme.min.js', array(), null, true );
